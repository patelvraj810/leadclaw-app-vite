export const convData = {
  sarah: {
    ...
    msgs: [
      ...
      { f: 'agent', t: "Booked! Share your address and Mike will call 30 mins before arriving 🙌", ts: '2:37 AM' },
      { f: 'lead', t: "123 Maple Street, Brampton. Thank you!", ts: '2:38 AM' },
      { f: 'agent', t: "All confirmed — Mike arrives 2–5 PM at 123 Maple St. Stay cool! 😊", ts: '2:38 AM' }
    ]
  },
  james: {
    id: 'james',
    ...
    channel: 'Email',
    sub: 'Real Estate Buyer · via Email',
    tag: 'In progress',
    tagCls: 'tag-amber',
    status: 'In Progress',
    time: '18m ago',
    ...
    msgs: [
      { f: 'lead', t: "Hi, looking to buy a 3-bedroom. What areas do you cover?", ts: '9:15 AM' },
      { f: 'agent', t: "Hi James! We cover the GTA — Brampton, Mississauga, Oakville, Burlington. Staying within a specific city or flexible?", ts: '9:15 AM' },
  ...
  aisha: {
    ...
    channel: 'WhatsApp',
    sub: 'Cleaning — Weekly · via WhatsApp',
    tag: 'Qualified',
    tagCls: 'tag-green',
    status: 'Qualified',
    time: '1h ago',
